...
// forge script scripts/FraxtalHub/4_SendFraxOFTFraxtalHub/SendFraxOFTStableToFraxtal.s.sol --rpc-url https://rpc.stable.xyz --broadcast --with-gas-price 0gwei --block-base-fee-per-gas=0 --gas-price=0 --priority-gas-price=0 

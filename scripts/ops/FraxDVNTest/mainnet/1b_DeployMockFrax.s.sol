...
// TODO : pending verification , sei : forge script ./scripts/ops/FraxDVNTest/mainnet/1b_DeployMockFrax.s.sol --rpc-url https://evm-rpc.sei-apis.com  --verifier-url $SEI_SEITRACE_API_URL --etherscan-api-key $SEI_SEITRACE_API_KEY --verifier blockscout --verify --broadcast
...
// TODO : pending deployment , linea : forge script ./scripts/ops/FraxDVNTest/mainnet/1b_DeployMockFrax.s.sol --rpc-url https://rpc.linea.build --verifier-url $LINEASCAN_API_URL --etherscan-api-key $LINEASCAN_API_KEY --verifier etherscan --verify --broadcast --evm-version paris

...
export function getMovementToEVMConnectionConfig(send: number, receive: number): OAppEdgeConfig {
    return {
...
export function getAptosToEVMConnectionConfig(send: number, receive: number): OAppEdgeConfig {
    return {
        enforcedOptions: [
            {
                msgType: MsgType.SEND,
...
export const ethereumContractConfig = {
    ...
    delegate: '0xB1748C79709f4Ba2Dd82834B8c82D4a505003f27',
}

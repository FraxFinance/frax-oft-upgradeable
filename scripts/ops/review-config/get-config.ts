...
const RATE_LIMITER_ABI = [
        ...
        outputs: [
            {
                components: [
                    ...
                    { internalType: "uint112", name: "outboundLimit", type: "uint112" },
                    { internalType: "uint112", name: "inboundLimit", type: "uint112" },
                ],
    ...
    },
    {
        ...
        outputs: [
            {
                components: [
                    { internalType: "uint112", name: "outboundUsage", type: "uint112" },
                    { internalType: "uint112", name: "inboundUsage", type: "uint112" },

...
export const chains: Record<string, ChainInfo> = {
    ...
    avalanche: {
        client: createPublicClient({
            chain: avalanche,
            transport: fallback([
                http(process.env.AVALANCHE_RPC_URL_1),
                http(process.env.AVALANCHE_RPC_URL_2),
                http(process.env.AVALANCHE_RPC_URL_3),
                http(process.env.AVALANCHE_RPC_URL_4),
            ]),
        }),
        peerId: 30106,
        endpoint: '0x1a44076050125825900e736c501f859c50fE728c',
    ...
    zkevm: {
        client: createPublicClient({
            chain: polygonZkEvm,
            transport: http(process.env.ZKEVM_RPC_URL),
        }),
        peerId: 30158,
        endpoint: '0x1a44076050125825900e736c501f859c50fE728c',

...
// forge script scripts/ops/deploy/BatchDeploy/3_DeployPolygon.s.sol --rpc-url https://polygon-rpc.com --verifier-url $POLYSCAN_API_URL --etherscan-api-key $POLYSCAN_API_KEY --verify --broadcast
contract DeployPolygon is DeployFraxOFTProtocol {

...
// forge script scripts/ops/UpgradeToMint/1b_UpgradeAdapterEthereum.s.sol --rpc-url https://rpc.frax.com
contract UpgradeAdapter is DeployFraxOFTProtocol {
    ...
    function generateOperatorTxs() public prankAndWriteTxs(broadcastConfig.delegate) {
        ...
        // transferProxyAdminOwnership(); // TODO: double-check ownership
    }

...
contract DeployFraxOFTProtocolFraxtalHub is DeployFraxOFTProtocol {
    ...
    function run() public override {
        ...
        // TODO : this would update when deployment is made
        ...
        // TODO : remove once mock frax OFTs deployment is done

        proxyOfts.push(0x65C042454005de49106a6B0129F4Af56939457da); // wfrax
        proxyOfts.push(0xE1851f6ac161d1911104b19918FB866eF6FEE577); // sfrxusd
        proxyOfts.push(0xb7583B07C12286bb9026A7053B0C44e8f5fa8624); // sfrxeth
        proxyOfts.push(0xA444F92734be29E71b8A4762595C9733Ab2C9c47); // frxusd
        proxyOfts.push(0xa5C2889F0E3DA388DF3BF87f8f0B8E56bB863C41); // frxeth
        proxyOfts.push(0xC6563942D1AE02Dd6e450847de3753011cA3eee1); // fpi
        setupSource();
    }

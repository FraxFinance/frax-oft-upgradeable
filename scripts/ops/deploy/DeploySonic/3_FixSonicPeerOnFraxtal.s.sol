...
// Fixes missed peer set of (s)frxUSD to Sonic
// forge script scripts/ops/deploy/DeploySonic/3_FixSonicPeerOnFraxtal.s.sol --rpc-url https://rpc.frax.com
contract FixArbitrumPeers is DeployFraxOFTProtocol {
    ...
    function filename() public view override returns (string memory) {
        ...
        string memory name = string.concat("146-", broadcastConfig.chainid.toString());
    ...
    function setEvmPeers(
        ...
        for (uint256 o=0; o<_connectedOfts.length; o++) {
            ...
            for (uint256 c=0; c<_configs.length; c++) {
                ...
                // skip writing peer if not to sonic

...
Sets the default config of the SendLib for each EVM chain so that the values are not 0
    ...
    - executor
*/
// Only to EVM (non-ZK) chains
// forge script scripts/ops/fix/FixDefaultSendConfig/FixDefaultSendConfigEvm.s.sol
contract FixDefaultSendConfigEvm is DeployFraxOFTProtocol {
